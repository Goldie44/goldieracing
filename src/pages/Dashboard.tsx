...
import { Calendar, Package, Gauge, Wallet, Flag, AlertTriangle, CheckCircle, RotateCcw } from "lucide-react";
import { PieChart, Pie, Cell, ResponsiveContainer, BarChart, Bar, XAxis, YAxis, Tooltip } from "recharts";
import StatCard from "../components/StatCard";
import PageHeader from "../components/PageHeader";
import { calendar, circuitTypes, stock, performance, totalBudget, usedBudget } from "../lib/f1Data";
...
export default function Dashboard() {
  ...
  const sortedRaces = calendar.filter(r => r.type !== "Test").sort((a, b) => new Date(a.date) - new Date(b.date));
